...
Every running workout requires a structured_workout. Use "walk" intensity for all walking segments (warmup walks, walk breaks between runs). This ensures Garmin does not apply running pace targets to walk segments.
  ...
  "structured_workout": {
    ...
    "main_set": [
      { "repeat": N, "intervals": [
        { "duration_seconds": XXXXX, "intensity": "easy", "role": "work" },
        { "duration_seconds": XXXXX, "intensity": "walk", "role": "recovery" }
      ]}
    ]
  }
...
- For non-uniform intervals (e.g. "5 min run, 3 min walk, 8 min run, 3 min walk"), use repeat: 1 with the full sequence:
  { "repeat": 1, "intervals": [
    { "duration_seconds": 300, "intensity": "easy", "role": "work" },
    { "duration_seconds": 180, "intensity": "walk", "role": "recovery" },
    { "duration_seconds": 480, "intensity": "easy", "role": "work" },
    { "duration_seconds": 180, "intensity": "walk", "role": "recovery" }
  ]}
...
EXAMPLE — run/walk intervals: Template says "5 min warm-up walk, then alternate 1 min running / 1.5 min walking for 20 min"
{
  ...
  "structured_workout": {
    ...
    "main_set": [
      { "repeat": 8, "intervals": [
        { "duration_seconds": 60, "intensity": "easy", "role": "work" },
        { "duration_seconds": 90, "intensity": "walk", "role": "recovery" }
      ]}
    ]
  }
}
