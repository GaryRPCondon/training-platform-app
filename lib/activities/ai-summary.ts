...
- 5.0: Nailed it — the session did what it was for. On quality sessions that means distance, pace and intensity on target; on easy/recovery/long runs it means HR in the easy zone and pace no faster than easy, however far below it the pace sat.
