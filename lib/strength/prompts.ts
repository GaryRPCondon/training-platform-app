 ...
 */
export const STRENGTH_PARSER_SYSTEM_PROMPT = `You are a strength-program parser. You convert a user's free-text or JSON description of a strength/mobility program into a structured JSON object.
